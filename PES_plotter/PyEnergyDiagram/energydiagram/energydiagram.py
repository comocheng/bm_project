...
class ED:
    def __init__(self, aspect='equal', level_linewidth=1):
        # plot parameters
        self.ratio = 1.6181
        self.dimension = 'auto'
        self.space = 'auto'
        ...
        self.fig = None
        self.ax = None
        self.level_linewidth = level_linewidth
    ...
    def plot(
        ...
        for level in self.data:
            ...
            ax.hlines(level[0], start, start + self.dimension, color=level[4], linewidth=self.level_linewidth)
