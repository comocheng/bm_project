...
with open(os.path.join('/work/westgroup/chao/sketches/cpox_sim/bm_models_final', 'data_processing.py')) as infile:
...
def make_input(binding_energies):
    ...
    out_file = os.path.join(out_dir, 'data_processing.py')
