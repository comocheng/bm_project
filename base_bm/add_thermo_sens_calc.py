...
with open(os.path.join('/work/westgroup/chao/sketches/cpox_sim/bm_models_final', 'thermo_sens_calc.py')) as infile:
...
def make_input(binding_energies):
    ...
    out_file = os.path.join(out_dir, 'thermo_sens_calc.py')
