...
out_root = '/work/westgroup/chao/sketches/cpox_sim/bm_models_final/base_models_sim/original'
...
def plot_ratio_comparisions(path_to_cti, data):
    ...
    axs[0].plot(ratios, ch4_conv, 'bo-', label=r'CH_4', color='limegreen')
    o2_conv = [d[1][4] for d in data]
    axs[0].plot(ratios, o2_conv, 'bo-', label=r'O_2', color='blue')
    ax2 = axs[0].twinx()
    ...
    axs[1].plot(ratios, h2_sel, 'bo-', label=r'H_2', color='purple')
    co2_sel = [d[1][5] for d in data]
    axs[1].plot(ratios, co2_sel, 'bo-', label=r'CO_2', color='navy')
    h2o_sel = [d[1][6] for d in data]
    axs[1].plot(ratios, h2o_sel, 'bo-', label=r'H_2O', color='dodgerblue')
    ...
    fig.set_figheight(6)
    fig.set_figwidth(16)
    out_dir = os.path.join(out_root, 'figures_no_ref')
    os.path.exists(out_dir) or os.makedirs(out_dir)
