...
if __name__ == "__main__":
    ...
    for tols in tol_comb:
        ...
        data = pool.map(partial(run_one_simulation, 'base_bm.yaml', tols[0], tols[1]), ratios, 1) #use functools partial
        pool.close()
        pool.join()
        # try:
        ...
        plot_ratio_comparisions('base_bm.yaml', ratio_comparison)
